...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<WarehouseLogisticsEditorBlazorApplication>();
            builder.Modules
                ...
                .AddViewVariants()
                .Add<WarehouseLogisticsEditor.Module.WarehouseLogisticsEditorModule>()
            	.Add<WarehouseLogisticsEditorBlazorModule>();
